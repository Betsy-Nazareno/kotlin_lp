...
_lr_goto_items = {'line':([0,153,158,164,],[1,157,160,165,]),'impresion':([0,153,158,164,],[2,2,2,2,]),'expression':([0,15,58,142,153,158,164,],[3,42,110,110,3,3,3,]),'condicionL':([0,78,153,158,164,],[4,125,4,4,4,]),'condicionR':([0,78,153,158,164,],[5,126,5,5,5,]),'condicionN':([0,78,153,158,164,],[6,127,6,6,6,]),'asignacion':([0,153,158,164,],[7,7,7,7,]),'for':([0,153,158,164,],[8,8,8,8,]),'if':([0,153,158,164,],[9,9,9,9,]),'stack':([0,153,158,164,],[10,10,10,10,]),'stack_actuar':([0,153,158,164,],[11,11,11,11,]),'instance_arraylist':([0,151,153,158,164,],[12,155,12,12,12,]),'def_estruct_tipoDato':([0,122,153,158,164,],[13,143,13,13,13,]),'term':([0,15,35,36,37,38,39,41,50,58,142,153,158,164,],[16,16,81,82,83,84,85,86,88,16,16,16,16,16,]),'keywordVariables':([0,153,158,164,],[26,26,26,26,]),'asignacionSimple':([0,26,153,158,164,],[27,75,27,27,27,]),'factor':([0,15,35,36,37,38,39,41,50,58,142,153,158,164,],[32,32,32,32,32,32,32,32,32,32,32,32,32,32,]),'opL':([18,19,128,129,],[51,54,51,54,]),'opR':([19,20,21,22,23,24,129,130,131,132,133,134,],[55,68,69,70,71,72,55,68,69,70,71,72,]),'stack_funciones':([56,],[94,]),'stack_isEmpty':([56,],[95,]),'stack_push':([56,],[96,]),'stack_pop':([56,],[97,]),'tipoDato':([57,80,122,],[101,136,101,]),'valor':([58,142,],[109,150,]),'condicion':([78,],[124,]),'else':([159,],[161,]),}
...
_lr_productions = [
  ...
  ('stack_push -> PUSH LPAREN ID RPAREN','stack_push',4,'p_stack_push','kotlin_sintactico_karla.py',192),
]
